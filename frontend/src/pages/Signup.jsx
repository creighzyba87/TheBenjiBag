  ...
  return (
    <div className="max-w-md mx-auto p-6">
      ...
      <form onSubmit={submit} className="bg-white border rounded-xl shadow-sm p-4 space-y-3">
        ...
        <input type="date" className="border rounded-lg p-2 w-full" value={dob} onChange={e=>setDob(e.target.value)} />
        ...
        <button className="rounded-lg bg-brand-600 text-white px-4 py-2">Create account</button>
